        ...
        if '\n' in data_buffer:
            ...
            if 'DATA' in data_buffer:
                ...
                if 'BUMPER' in data_buffer:
                    ...
                    x += int(40*sin(radians(v_angle+angle_offset)))
                    y += int(40*cos(radians(v_angle+angle_offset)))
                ...
                if 'CLIFF' in data_buffer or 'BOUND' in data_buffer:
                    ...
                    x = int(v_x+center_x + 30*sin(radians(v_angle+dangle)))
                    y = int(v_y+center_y + 30*cos(radians(v_angle+dangle)))

                    v_y -= 35*cos(radians(v_angle))/5.5
                    v_x -= 35*sin(radians(v_angle))/5.5
